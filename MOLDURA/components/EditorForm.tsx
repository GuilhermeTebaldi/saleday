      ...
      <div className="md:col-span-2 space-y-4 pt-4 border-t border-gray-50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="space-y-1">
            ...
            <input name="areaM2" type="number" value={data.areaM2 || ''} onChange={handleChange} className={inputClass} />
          </div>
          <div className="space-y-1">
            <label className={labelClass}>Quartos</label>
            <input name="quartos" type="number" value={data.quartos || ''} onChange={handleChange} className={inputClass} />
          </div>
          <div className="space-y-1">
            <label className={labelClass}>Banheiros</label>
            <input name="banheiros" type="number" value={data.banheiros || ''} onChange={handleChange} className={inputClass} />
          </div>
          <div className="space-y-1">
            <label className={labelClass}>Vagas</label>
            <input name="vagas" type="number" value={data.vagas || ''} onChange={handleChange} className={inputClass} />
          </div>
        </div>
      </div>
    </div>
